...
namespace NET_CORE_PDF.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,FechaInicio,TipoDocumento,Documento,Cargo")] Persona persona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,FechaInicio,TipoDocumento,Documento,Cargo")] Persona persona)
        {
            if (id != persona.Id)
            {
                return NotFound();
